...
export class GestionarClientesComponent implements OnInit {
  ...
  abrirModalCrearCliente(): void {
    const camposAutor: CampoFormulario[] = [
      { nombre: 'nombre', etiqueta: 'Nombre del cliente', placeholder: 'Ingrese el nombre', required: true },
      { nombre: 'email', etiqueta: 'Correo electronico', placeholder: 'Ingrese el correo', required: true },
      { nombre: 'celular', etiqueta: 'Numero de celular', placeholder: 'Ingrese el telefono', required: true },
      // Agrega más campos según tus necesidades
    ];
  
    this.abrirModal('Crear Cliente', camposAutor);
  }
